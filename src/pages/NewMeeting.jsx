...
const NewMeeting = () => {
  ...
  const defaultDate = new URLSearchParams(window.location.search).get('date') || ''
  ...
  return (
    <DashboardLayout title="New Meeting">
      <div style={{ maxWidth: '680px' }}>
        ...
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-800">Schedule a Meeting</h2>
          <p className="text-sm text-gray-400 mt-1">Fill in the details to create a new meeting</p>
        </div>
